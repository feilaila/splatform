...
public class LoginService {
	...
	public SysUser getUserInfoByUsername(SysUser sysUser) {
		SysUser user = userMapper.selectByUserInfo(sysUser.getUsercode());
		if(null != user){
			//返回当前用户
			return user;
		}
