package com.splatform.manage.pojo;

import java.util.ArrayList;
import java.util.List;

import com.splatform.manage.entity.SysMenu;
import com.splatform.manage.entity.SysRole;
...
public class LoginUser {
	...
	/**
	 * 代替SysMenu的功能
	 * 登录用户所具有的全新模块对象列表 注意：针对超级管理员system帐户，roleList和srpList都没有值，但是modelList肯定有值
	 */
	private List<SysMenu> modelList = new ArrayList<SysMenu>();
...
//	}
	...
	public List<SysMenu> getModelList() {
		return modelList;
	}

	public void setModelList(List<SysMenu> list) {
		this.modelList = list;
	}
